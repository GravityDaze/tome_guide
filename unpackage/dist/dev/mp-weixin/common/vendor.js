...
// 导游建团
exports.sendMsg = sendMsg;var group = function group(data) {return _request.http.post('/guider/touristTeam/add', data);};exports.group = group;
...
var map = {
	...
	"./gohere.png": 92,
	"./guanbi@2x.png": 58,
	"./icon-shaixuan@2x.png": 59,
	"./icon_jingdiansheshi@2x.png": 60,
	"./icon_quanbudianpu@2x.png": 61,
	"./icon_quanbufabuxiaoxi@2x.png": 62,
	"./icon_quanbugerenzhongxin@2x.png": 63,
	"./icon_quanbuguanbiweilan@2x.png": 64,
	"./icon_quanbujingdian@2x.png": 65,
	"./icon_quanbuxiaoxi@2x.png": 66,
	"./icon_quanbuzutuan@2x.png": 67,
	"./img_touxiangdaoyou@2x.png": 68,
	"./jiuyuanxiangqingsos@2x.png": 70,
	"./local.png": 71,
	"./location.png": 72,
	"./logo.png": 73,
	"./menu.png": 74,
	"./scenery.png": 75,
	"./servicestation.png": 76,
	"./shop.png": 77,
	"./sos@2x.png": 78,
	"./toilet.png": 53,
	"./youke@2x.png": 79,
