...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.dismiss = exports.delMember = exports.queryTeamInfo = exports.queryTravelAgencyList = exports.isCreateTeam = exports.createTeam = exports.sendMsg = exports.queryScenicSpot = exports.queryFacilities = exports.queryFence = exports.queryUserInfo = exports.querySceneryNum = exports.login = exports.validateCode = exports.getCode = void 0;var _request = __webpack_require__(/*! @/utils/request.js */ 22);
...
// 通过经纬度查询到景区编号
exports.login = login;var querySceneryNum = function querySceneryNum(data) {return _request.http.post('/guider/scenice/getSceneryBylon', data);};
...
// 导游发送信息
exports.queryScenicSpot = queryScenicSpot;var sendMsg = function sendMsg(data) {return _request.http.post('/guider/message/sendMsg', data);};

// 导游建团
exports.sendMsg = sendMsg;var createTeam = function createTeam(data) {return _request.http.post('/guider/touristTeam/creatTeam', data);};

// 查询导游是否建团
exports.createTeam = createTeam;var isCreateTeam = function isCreateTeam(data) {return _request.http.post('/guider/touristTeam/getTeam', data);};
...
// 解散团队
exports.delMember = delMember;var dismiss = function dismiss(data) {return _request.http.post('/guider/touristTeam/dismiss', data);};exports.dismiss = dismiss;
...
var map = {
	...
	"./gohere.png": 58,
	"./guanbi@2x.png": 59,
	"./icon-shaixuan@2x.png": 60,
	"./icon_daoyouitixing.png": 61,
	"./icon_daoyoutixingyidu.png": 62,
	"./icon_jingdiansheshi@2x.png": 63,
	"./icon_jingquitixingyidu.png": 64,
	"./icon_jingqutixing.png": 65,
	"./icon_quanbudianpu@2x.png": 66,
	"./icon_quanbufabuxiaoxi@2x.png": 67,
	"./icon_quanbugerenzhongxin@2x.png": 68,
	"./icon_quanbuguanbiweilan@2x.png": 69,
	"./icon_quanbujingdian@2x.png": 70,
	"./icon_quanbuxiaoxi@2x.png": 71,
	"./icon_quanbuzutuan@2x.png": 72,
	"./icon_tumitixing.png": 73,
	"./icon_tumitixingyidu.png": 74,
	"./img_touxiangdaoyou@2x.png": 75,
	"./info.png": 89,
	"./jiuyuanxiangqingsos@2x.png": 76,
	"./local.png": 77,
	"./location.png": 78,
	"./logo.png": 79,
	"./member.png": 96,
