...

{
  ...
  methods: {
    ...
    // 获取到景区
    getScenery: function getScenery() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  (0, _api.querySceneryNum)({
                    // lat:  getApp().globalData.latitude,
                    // lon:  getApp().globalData.longitude
                    "lon": 116.304279,
                    "lat": 40.012476 }));case 2:res = _context.sent;

                _this.scenery = res.value.name;
                getApp().globalData.sceneryNo = res.value.no;
                // 获取到围栏
                _this.getFence();
                // 获取到景点及设施
                _this.getFacilities();
                _this.getScenicSpot();case 8:case "end":return _context.stop();}}}, _callee);}))();
    },

    // 获取到设施
    getFacilities: function getFacilities() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  (0, _api.queryFacilities)({
                    sceniceNo: getApp().globalData.sceneryNo }));case 2:res = _context2.sent;if (!(

                JSON.stringify(res.value) === JSON.stringify(_this2.facilitiesData))) {_context2.next = 5;break;}return _context2.abrupt("return",
                console.log('重复数据不予添加'));case 5:


                // 储存标记点信息
                _this2.facilitiesData = res.value;
                res.value.forEach(function (v) {
                  _this2.markers.push({
                    height: 78,
                    iconPath: "/static/".concat(_this2.iconPath.get(v.type), ".png"),
                    id: 's' + v.id,
                    latitude: v.lat,
                    longitude: v.lon,
                    width: 65 });
    ...
    getScenicSpot: function getScenicSpot() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                  (0, _api.queryScenicSpot)({
                    sceniceNo: getApp().globalData.sceneryNo }));case 2:res = _context3.sent;if (!(


                JSON.stringify(res.value) === JSON.stringify(_this3.sceneryData))) {_context3.next = 5;break;}return _context3.abrupt("return",
                console.log('重复数据不予添加'));case 5:


                // 储存标记点信息
                _this3.sceneryData = res.value;
                res.value.forEach(function (v) {
                  _this3.markers.push({
                    height: 78,
    ...
    // 开启定时器
    startTimer: function startTimer() {var _this4 = this;
    ...
    // 获取到地理位置
    getLocation: function getLocation() {var _this5 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee6() {var _yield$uni$getLocatio, _yield$uni$getLocatio2, err, res, _yield$uni$getSetting, _yield$uni$getSetting2, _err, _res;return _regenerator.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:_context6.next = 2;return (
                  uni.getLocation({
                    type: 'gcj02' }));case 2:_yield$uni$getLocatio = _context6.sent;_yield$uni$getLocatio2 = _slicedToArray(_yield$uni$getLocatio, 2);err = _yield$uni$getLocatio2[0];res = _yield$uni$getLocatio2[1];if (!


                err) {_context6.next = 16;break;}_context6.next = 9;return (
                  uni.getSetting());case 9:_yield$uni$getSetting = _context6.sent;_yield$uni$getSetting2 = _slicedToArray(_yield$uni$getSetting, 2);_err = _yield$uni$getSetting2[0];_res = _yield$uni$getSetting2[1];
                if (_res.authSetting['scope.userLocation'] === false) {
                  uni.showModal({
                    title: '提示',
                    content: '检测到您拒绝了地理位置授权，这将无法获取到正确的位置，是否重新进行授权 ?',
                    success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(res) {var _yield$uni$openSettin, _yield$uni$openSettin2, _err2, _res2;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:if (!
                                res.confirm) {_context4.next = 10;break;}_context4.next = 3;return (
                                  uni.openSetting());case 3:_yield$uni$openSettin = _context4.sent;_yield$uni$openSettin2 = _slicedToArray(_yield$uni$openSettin, 2);_err2 = _yield$uni$openSettin2[0];_res2 = _yield$uni$openSettin2[1];
                                _res2.authSetting['scope.userLocation'] && _this5.getLocation();_context4.next = 11;break;case 10:

                                uni.showToast({
                                  title: '授权失败',
                                  icon: 'none',
                                  duration: 1000 });case 11:case "end":return _context4.stop();}}}, _callee4);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });




                }_context6.next = 22;break;case 16:
                ...
                uni.startLocationUpdate({
                  success: function success() {
                    uni.onLocationChange( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5(r) {return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                                getApp().globalData.latitude = r.latitude;
                                getApp().globalData.longitude = r.longitude;case 2:case "end":return _context5.stop();}}}, _callee5);}));return function (_x2) {return _ref.apply(this, arguments);};}());
    ...
    // 渲染电子围栏
    getFence: function getFence() {var _this6 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee7() {var res, list;return _regenerator.default.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:_context7.next = 2;return (
                  (0, _api.queryFence)({
                    sceneryNo: getApp().globalData.sceneryNo }));case 2:res = _context7.sent;

                // 生成多边形

                list =
                res.value.list;
                _this6.polygons = list.map(function (v) {
                  var latLng = v.scope.split(';');
                  var points = latLng.map(function (v) {
                    var latitude = parseFloat(v.split(',')[1]);
                    var longitude = parseFloat(v.split(',')[0]);
                    return {
                      latitude: latitude,
                      longitude: longitude };
                ...
                console.log(_this6.polygons);case 6:case "end":return _context7.stop();}}}, _callee7);}))();
    },
    ...
    // 生成标记信息
    createMakerInfo: function createMakerInfo(markerData, markerType, curId) {var _this7 = this;var _iterator = _createForOfIteratorHelper(
      markerData),_step;try {var _loop = function _loop() {var item = _step.value;
